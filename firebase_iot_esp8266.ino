...
#define WIFI_SSID "2chuongvang"
#define WIFI_PASSWORD "66668888"

/* 2. Define the API Key */
#define API_KEY "AIzaSyCnpTHwFFjivsicmuRW3MmBe00c0X10we0"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://eng-electron-307120-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "hunghmph11474@fpt.edu.vn"
...
//    Serial.printf("Set int... %s\n", Firebase.setInt(fbdo, "/test/int", count) ? "ok" : fbdo.errorReason().c_str());
    ...
    if(Firebase.getInt(fbdo, "/test/int")){
      value_s = String(fbdo.to<int>()).c_str();
    }else{
      value_s = fbdo.errorReason().c_str();
    }
